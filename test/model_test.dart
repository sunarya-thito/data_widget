...
main() {
  ...
  testWidgets('ModelReadOnly test', (tester) async {
    ...
    await tester.tap(find.text('Increment from Child'));
    ...
    await tester.tap(find.text('Toggle from Child'));
    expect(tester.takeException(), isAssertionError);
    await tester.pump();
    expect(find.text('Counter: 0'), findsOneWidget);
    expect(find.text('Flag: false'), findsOneWidget);
  ...
  testWidgets('ModelBuilder test', (tester) async {
    ...
    await tester.tap(find.text('Increment from Builder'));
    await tester.pump();
    expect(find.text('Counter: 1'), findsOneWidget);
    expect(find.text('Flag: false'), findsOneWidget);

    await tester.tap(find.text('Toggle from Builder'));
    await tester.pump();
    expect(find.text('Counter: 1'), findsOneWidget);
    expect(find.text('Flag: true'), findsOneWidget);
  });
